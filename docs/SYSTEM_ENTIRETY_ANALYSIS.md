...
| SCB | Supply Chain Architect | [pipeline/pages/1_Supply_Chain_Architect.py](../pipeline/pages/1_Supply_Chain_Architect.py) | Network graph + risk control room | Azure SQL |
