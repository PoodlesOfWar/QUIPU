...
# Perception Mk1 (v0.20.16) introduced as the 6th sense, contributing 0.14.
# Existing senses each reduced by ~0.02 to keep the sum at exactly 1.0.
_SENSE_WEIGHTS = {
    "vision":      0.22,
    "touch":       0.22,
    "smell":       0.18,
...
def _sense_signals() -> dict:
    ...
    try:
        from .perception import get_perception_coherence
        out["perception"] = get_perception_coherence()
    except Exception:
        out["perception"] = 0.0
