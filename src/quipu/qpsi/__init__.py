...
from . import flux_phase, memristive_axes, learned_prior, mirror_training, coherency_depth  # noqa: F401  (submodules; generic names like step/rows/field stay namespaced; self_organising is imported by src/quipu/__init__ under its flag)
